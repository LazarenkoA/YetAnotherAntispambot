...
func (c *Client) prompt() string {
	return fmt.Sprintf("Ты модератор IT чата. Зашел новый участник и отправил новое сообщение, произведи анализ сообщения из чата и оцени вероятность того, что оно является спамом.\n" +
